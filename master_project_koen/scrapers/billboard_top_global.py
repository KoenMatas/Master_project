...
class BillboardSpider(Spider):
    ...
    def start_requests(self):
        """
        This method yields the urls from date of choice to the current date with one week difference
        """
        ...
        while True:
            ...
            yield scrapy.Request(
                url=f'https://www.billboard.com/charts/billboard-global-200/{new_date.__str__()}',
                callback=self.parse,
